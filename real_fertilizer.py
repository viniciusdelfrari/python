...
pounds_of_nitrogen = total_area * 0.5
pounds_of_potassium = total_area * 0.125
...
print(f"The total cost to the company will be ${total_cost:.2f}. The application will result in {pounds_of_nitrogen:.0f} pounds of nitrogen and {pounds_of_potassium:.0f} pounds of potassium being added to the soil.")
